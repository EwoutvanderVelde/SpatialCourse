...
```{r}
saveRDS(spatialHousePriceRF, file = 'data/Spatialfitv4.rds')
```


```{r}
#spatialHousePriceRF <- readRDS('data/Spatialfitv3.rds')
```


```{r}
spatialHousePriceRF <- rf_tuning(
...
```{r}
saveRDS(spatialHousePriceRF, file = 'data/Spatialtunev4.rds')
```



```{r}
spatialHousePriceRF <- readRDS('data/Spatialtunev4.rds')
```
...
spatialHousePriceRF.repeat <- spatialRF::rf_repeat(
  model = spatialHousePriceRF, 
  repetitions = 5,
  seed = randon.seed,
  verbose = TRUE
...
```{r}
spatialHousePriceRF.repeat
```


```{r}
#saveRDS(spatialHousePriceRF.repeat, file = 'data/Spatialtunerepeatv2.rds')
```

```{r}
#spatialHousePriceRF.repeat <- readRDS('data/Spatialtunerepeatv2.rds')
```
...
# singe value data
write.csv(spatialHousePriceRF.repeat$num.trees, 
          file = paste(start, "num_trees", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$num.independent.variables, 
          file = paste(start, "num_independent_variables", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$mtry, 
          file = paste(start, "mtry", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$min.node.size, 
          file = paste(start, "min_node_size", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$prediction.error, 
          file = paste(start, "prediction_error", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$r.squared, 
          file = paste(start, "r_squared", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$num.samples, 
          file = paste(start, "num_samples", ".csv" , sep = ""))


# simple vectors
write.csv(spatialHousePriceRF.repeat$variable.importance, 
          file = paste(start, "variable_importance", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$variable.importance.local, 
          file = paste(start, "variable_importance_local", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$performance, 
          file = paste(start, "performance", ".csv" , sep = ""))

# for the complex
write.csv(spatialHousePriceRF.repeat$residuals$values, 
          file = paste(start, "residuals_values", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$residuals$values.median, 
          file = paste(start, "residuals_values_median", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$residuals$values.repetitions, 
          file = paste(start, "residuals_values_repetitions", ".csv" , sep = ""))

write.csv(spatialHousePriceRF.repeat$predictions$values, 
          file = paste(start, "predictions_values", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$predictions$values.per.repetition, 
          file = paste(start, "prediction_values_per_repetition", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$predictions$values.median, 
          file = paste(start, "prediction_values_median", ".csv" , sep = ""))

write.csv(spatialHousePriceRF.repeat$importance$per.variable, 
          file = paste(start, "importance_per_variable", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$importance$per.repetition, 
          file = paste(start, "importance_per_repetition", ".csv" , sep = ""))
write.csv(spatialHousePriceRF.repeat$importance$local, 
