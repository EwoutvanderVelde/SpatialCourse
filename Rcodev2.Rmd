...
```{r}
predictors = c("bedrooms", "bathrooms", "half_bathrooms", "lot_size", "construction_size", "property_type_id_id", "real_age", "parks", "schools", "university", "hospital", "sport_facility", "supermarket", "mall", "historic", "museum", "industry", "subway", "bus", "stadium", "airport")
...
write.csv(spatialHousePriceRF2.repeat$predictions$values.per.repetition,
          file = "data/predictions_per_repetition.csv")
